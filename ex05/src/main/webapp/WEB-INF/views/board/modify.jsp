...
$(document).ready(function(){
		...
		$.getJSON("/board/getAttachList", {bno: bno}, function(arr){
			...
			$(arr).each(function(i, attach){
				...
				if(attach.fileType){
					...
					+ fileCallPath + "\' data-type='image' class='btn btn-warning btn-circle'><i class='fa fa-times'></i></button><br>";
	...
	var regex = new RegExp("(.*?)\.(wxw|sh|zip|alz)$");
	var maxSize = 5242880;
